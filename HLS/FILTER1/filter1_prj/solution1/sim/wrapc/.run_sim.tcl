...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "filter1.autotvin.dat"
	set constFileTvOut       "filter1.autotvout.dat"
	set constFileHdlTvIn     "filter1.autohdltvin.dat"
	set constFileHdlTvOut    "filter1.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"

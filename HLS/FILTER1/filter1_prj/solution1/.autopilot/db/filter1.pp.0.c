...
void iir_filter_reset(void) {
    VITIS_LOOP_44_1: for (int i = 0; i < 3; ++i) {
        filter_state[i].w1 = 0;
        filter_state[i].w2 = 0;
    }
}
...
__attribute__((sdx_kernel("filter1", 0))) int32_t filter1(int32_t input) {
#line 15 "/home/caccolillo/Downloads/TUTORIAL_FSK/FSK_MODEM/HLS/FILTER1/filter1_prj/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=filter1
# 64 "filter1.c"

...
with open('./band_pass_filter_10k/solution1/csim/build/step_response.csv', 'r') as file:
...
with open('./band_pass_filter_10k/solution1/csim/build/chirp_response.csv', 'r') as file:
    reader = csv.DictReader(file)
    for row in reader:

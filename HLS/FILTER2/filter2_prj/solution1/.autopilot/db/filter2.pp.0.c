...
# 2 "<built-in>" 2
# 1 "HLS/FILTER2/filter2.c" 2

# 1 "HLS/FILTER2/filter2.h" 1
...
__attribute__((sdx_kernel("filter2", 0))) int32_t filter2(int32_t input) {
#line 15 "/home/caccolillo/Downloads/TUTORIAL_FSK/FSK_MODEM/filter2_prj/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=filter2
# 92 "HLS/FILTER2/filter2.c"
